...
public class ScalingStream : MonoBehaviour
{
    ...
    private Vector3 vector_0;
    private Vector3 vector_1;
    private Vector3 vector_2;
    private Vector3 vector_3;
    [Range(1, 30)]
    public int speed = 10;
    // varibales for rotation matrix
    private float phi_0; //z rotation
    private float theta_0; // x rotation
    private float phi_1; //z rotation
    private float theta_1; // x rotation
    private float theta;
    private float phi;
